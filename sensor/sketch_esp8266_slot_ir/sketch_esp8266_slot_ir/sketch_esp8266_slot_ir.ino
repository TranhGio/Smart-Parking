...
const char *mqtt_slot_ir1_topic = "smartparking/slot/infrared_sensor1";
const char *mqtt_slot_ir2_topic = "smartparking/slot/infrared_sensor2";
const char *mqtt_slot_ir3_topic = "smartparking/slot/infrared_sensor3";
const char *mqtt_slot_ir4_topic = "smartparking/slot/infrared_sensor4";
